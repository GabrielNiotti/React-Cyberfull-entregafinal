...
const ProtectedRoute = ({ children,rolesPermitidos }) => {
  ...
  // Mientras se verifica el estado de autenticación, mostramos un mensaje de carga.src/componentes/ProtectedRoute/PotectedRoute.jsx // Esto es crucial para no redirigir al login prematuramente en una recarga de página.
